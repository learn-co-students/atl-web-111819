...
# Use rspec --fail-fast to handle one error at a time
# Red, Green, Refactor - make it work, make it right, make it fast
# Define debugging
# Describe how to stop a program and check variables with binding.pry



# Okay, let's start with our data! Let's break down nested hashes.
...
def get_all_players
  ...
  # Let's check what we have as a result! What do we use?  
